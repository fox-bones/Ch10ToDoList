...
namespace ToDoList.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ViewResult Add()
        {
            ...
            newToDo.Categories = context.Categories.ToList();
            newToDo.Statuses = context.Statuses.ToList();
            newToDo.CurrentTask = new ToDo { StatusId = "open" };  // set default value for drop-
            return View(newToDo);
        }
